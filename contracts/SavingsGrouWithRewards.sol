 ...
 */
contract SavingsGroupWithRewards is SavingGroups {
    ...
    /**
     * @notice Override endRound to finalize the round automatically trigger
    ...
    function endRound() public override atStage(Stages.Save) {
        ...
        if (stage == Stages.Finished) {
            ...
            rewardsVault.distributeRewards(rewardToken, ad
